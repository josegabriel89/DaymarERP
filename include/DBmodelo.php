...
class DB {
    ...
    protected static function conectar() {
        ...
        $dsn = "mysql:host=localhost;dbname=pruebaBDplantilla"; //MODIFICAR EL NOMBRE DE LA BASE DE DATOS A LA CUAL SE ACCEDE
        $usuario = 'dwes'; //ATENCION POR SI EL USUARIO FUERA DISTINTO
        $contrasena = 'abc123.';
